...
int vars_length = 34, lists_length = 8;
...
#define YIELD
	...
	_0_t = ((((ScratchVarGetDouble(_0_RasterY2)) - (ScratchVarGetDouble(_0_RasterY3)))) / (double)(((ScratchVarGetDouble(_0_RasterY1)) - (ScratchVarGetDouble(_0_RasterY3)))));
	_0_RasterX4 = ((((_0_t) * (((ScratchVarGetDouble(_0_RasterX1)) - (ScratchVarGetDouble(_0_RasterX3)))))) + (ScratchVarGetDouble(_0_RasterX3)));
	_0_RasterY4 = _0_RasterY2;
	_0_RasterU4 = ((((_0_t) * (((ScratchVarGetDouble(_0_RasterU1)) - (ScratchVarGetDouble(_0_RasterU3)))))) + (ScratchVarGetDouble(_0_RasterU3)));
	_0_RasterV4 = ((((_0_t) * (((ScratchVarGetDouble(_0_RasterV1)) - (ScratchVarGetDouble(_0_RasterV3)))))) + (ScratchVarGetDouble(_0_RasterV3)));
	_0_RasterZ4 = ((((_0_t) * (((ScratchVarGetDouble(_0_RasterZ1)) - (ScratchVarGetDouble(_0_RasterZ3)))))) + (ScratchVarGetDouble(_0_RasterZ3)));
	_();
	if(!(operator_equals(_0_RasterY2, _0_RasterY1)))
	{
		_0_dx1 = ((0.0) - (((((ScratchVarGetDouble(_0_RasterX2)) - (ScratchVarGetDouble(_0_RasterX1)))) / (double)(((ScratchVarGetDouble(_0_RasterY2)) - (ScratchVarGetDouble(_0_RasterY1)))))));
		_0_dx2 = ((0.0) - (((((_0_RasterX4) - (ScratchVarGetDouble(_0_RasterX1)))) / (double)(((ScratchVarGetDouble(_0_RasterY4)) - (ScratchVarGetDouble(_0_RasterY1)))))));
		_0_dvx1 = ((0.0) - (((((ScratchVarGetDouble(_0_RasterV2)) - (ScratchVarGetDouble(_0_RasterV1)))) / (double)(((ScratchVarGetDouble(_0_RasterY2)) - (ScratchVarGetDouble(_0_RasterY1)))))));
		_0_dux1 = ((0.0) - (((((ScratchVarGetDouble(_0_RasterU2)) - (ScratchVarGetDouble(_0_RasterU1)))) / (double)(((ScratchVarGetDouble(_0_RasterY2)) - (ScratchVarGetDouble(_0_RasterY1)))))));
		_0_dvx2 = ((0.0) - (((((_0_RasterV4) - (ScratchVarGetDouble(_0_RasterV1)))) / (double)(((ScratchVarGetDouble(_0_RasterY2)) - (ScratchVarGetDouble(_0_RasterY1)))))));
		_0_dux2 = ((0.0) - (((((_0_RasterU4) - (ScratchVarGetDouble(_0_RasterU1)))) / (double)(((ScratchVarGetDouble(_0_RasterY2)) - (ScratchVarGetDouble(_0_RasterY1)))))));
		_0_dzkh1 = ((0.0) - (((((ScratchVarGetDouble(_0_RasterZ2)) - (ScratchVarGetDouble(_0_RasterZ1)))) / (double)(((ScratchVarGetDouble(_0_RasterY2)) - (ScratchVarGetDouble(_0_RasterY1)))))));
		_0_dzkh2 = ((0.0) - (((((_0_RasterZ4) - (ScratchVarGetDouble(_0_RasterZ1)))) / (double)(((ScratchVarGetDouble(_0_RasterY2)) - (ScratchVarGetDouble(_0_RasterY1)))))));
		...
		for(int i2 = 0; i2 < (int)((((1) + (((ScratchVarGetDouble(_0_RasterY1)) - (ScratchVarGetDouble(_0_RasterY4))))))); i2++)
		{
			_0_RXRound = round((ScratchVarGetDouble(_0_RasterXRight)));
			_0_Rx2Round = round((ScratchVarGetDouble(_0_RasterXLeft)));
			...
			{
				_0_RXRound = round((ScratchVarGetDouble(_0_RasterXLeft)));
				_0_Rx2Round = round((ScratchVarGetDouble(_0_RasterXRight)));
			...
			_0_RasterLineUD = ((((ScratchVarGetDouble(_0_RU2)) - (ScratchVarGetDouble(_0_RU1)))) / (double)(((_0_Rx2Round) - (_0_RXRound))));
			_0_RasterLineVC = _0_Rv1;
			_0_RasterLineVd = ((((ScratchVarGetDouble(_0_Rv2)) - (ScratchVarGetDouble(_0_Rv1)))) / (double)(((_0_Rx2Round) - (_0_RXRound))));
			_0_RasterLineZC = _0_Rzkh1;
			_0_RasterLineZD = ((((ScratchVarGetDouble(_0_Rzkh2)) - (ScratchVarGetDouble(_0_Rzkh1)))) / (double)(((_0_Rx2Round) - (_0_RXRound))));
			motion_gotoxy(round((_0_RXRound)), round((ScratchVarGetDouble(_0_y_raster))));
			for(int i3 = 0; i3 < (int)((((_0_Rx2Round) - (_0_RXRound)))); i3++)
			{
				_Set_Colour_zfcs_zfcs(_0_RasterLineUC, _0_RasterLineVC);
				motion_changexby(1);
				_0_RasterLineUC = ScratchSetDouble(ScratchVarGetDouble(_0_RasterLineUC) + _0_RasterLineUD);
				_0_RasterLineVC = ScratchSetDouble(ScratchVarGetDouble(_0_RasterLineVC) + _0_RasterLineVd);
				_0_RasterLineZC = ScratchSetDouble(ScratchVarGetDouble(_0_RasterLineZC) + _0_RasterLineZD);
				if(1 < ScratchVarGetDouble(_0_RasterLineUC))
				{
					_0_RasterLineUC = ScratchSetDouble(1);
				}
				if(1 < ScratchVarGetDouble(_0_RasterLineVC))
				{
					_0_RasterLineVC = ScratchSetDouble(1);
				}
				YIELD
			}
			_0_y_raster = ScratchSetDouble(ScratchVarGetDouble(_0_y_raster) + -1);
			_0_RasterXLeft = ScratchSetDouble(ScratchVarGetDouble(_0_RasterXLeft) + _0_dx1);
			_0_RasterXRight = ScratchSetDouble(ScratchVarGetDouble(_0_RasterXRight) + _0_dx2);
			_0_RasterVLeft = ScratchSetDouble(ScratchVarGetDouble(_0_RasterVLeft) + _0_dvx1);
			_0_RasterULeft = ScratchSetDouble(ScratchVarGetDouble(_0_RasterULeft) + _0_dux1);
			_0_RasterVRight = ScratchSetDouble(ScratchVarGetDouble(_0_RasterVRight) + _0_dvx2);
			_0_RasterURight = ScratchSetDouble(ScratchVarGetDouble(_0_RasterURight) + _0_dux2);
			_0_RasterZLeft = ScratchSetDouble(ScratchVarGetDouble(_0_RasterZLeft) + _0_dzkh1);
			_0_RasterZRight = ScratchSetDouble(ScratchVarGetDouble(_0_RasterZRight) + _0_dzkh2);
			YIELD
		}
	}
	_();
	if(!(operator_equals(_0_RasterY2, _0_RasterY3)))
	{
		_0_dx1 = ((((ScratchVarGetDouble(_0_RasterX2)) - (ScratchVarGetDouble(_0_RasterX3)))) / (double)(((ScratchVarGetDouble(_0_RasterY2)) - (ScratchVarGetDouble(_0_RasterY3)))));
		_0_dx2 = ((((_0_RasterX4) - (ScratchVarGetDouble(_0_RasterX3)))) / (double)(((ScratchVarGetDouble(_0_RasterY4)) - (ScratchVarGetDouble(_0_RasterY3)))));
		_0_dvx1 = ((((ScratchVarGetDouble(_0_RasterV2)) - (ScratchVarGetDouble(_0_RasterV3)))) / (double)(((ScratchVarGetDouble(_0_RasterY2)) - (ScratchVarGetDouble(_0_RasterY3)))));
		_0_dux1 = ((((ScratchVarGetDouble(_0_RasterU2)) - (ScratchVarGetDouble(_0_RasterU3)))) / (double)(((ScratchVarGetDouble(_0_RasterY2)) - (ScratchVarGetDouble(_0_RasterY3)))));
		_0_dvx2 = ((((_0_RasterV4) - (ScratchVarGetDouble(_0_RasterV3)))) / (double)(((ScratchVarGetDouble(_0_RasterY4)) - (ScratchVarGetDouble(_0_RasterY3)))));
		_0_dux2 = ((((_0_RasterU4) - (ScratchVarGetDouble(_0_RasterU3)))) / (double)(((ScratchVarGetDouble(_0_RasterY4)) - (ScratchVarGetDouble(_0_RasterY3)))));
		_0_dzkh1 = ((((ScratchVarGetDouble(_0_RasterZ2)) - (ScratchVarGetDouble(_0_RasterZ3)))) / (double)(((ScratchVarGetDouble(_0_RasterY2)) - (ScratchVarGetDouble(_0_RasterY3)))));
		_0_dzkh2 = ((((_0_RasterZ4) - (ScratchVarGetDouble(_0_RasterZ3)))) / (double)(((ScratchVarGetDouble(_0_RasterY4)) - (ScratchVarGetDouble(_0_RasterY3)))));
		...
		for(int i2 = 0; i2 < (int)((((0) + (ceil((((ScratchVarGetDouble(_0_RasterY4)) - (ScratchVarGetDouble(_0_RasterY3))))))))); i2++)
		{
			_0_RXRound = round((ScratchVarGetDouble(_0_RasterXRight)));
			_0_Rx2Round = round((ScratchVarGetDouble(_0_RasterXLeft)));
			_0_RU1 = _0_RasterURight;
			...
			_0_RasterLineZC = _0_Rzkh1;
			_0_RasterLineZD = ((((ScratchVarGetDouble(_0_Rzkh2)) - (ScratchVarGetDouble(_0_Rzkh1)))) / (double)(((_0_Rx2Round) - (_0_RXRound))));
			motion_gotoxy(_0_RXRound, round((ScratchVarGetDouble(_0_y_raster))));
			_Set_Colour_zfcs_zfcs(_0_RasterLineUC, _0_RasterLineVC);
			for(int i3 = 0; i3 < (int)((((_0_Rx2Round) - (_0_RXRound)))); i3++)
			{
				_Set_Colour_zfcs_zfcs(_0_RasterLineUC, _0_RasterLineVC);
